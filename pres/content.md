...
Find all persons
	...
	!clojure
	[:find ?p :in $ :where [?p :person/height _]]
...
Find team and salary for Zlatan Ibrahimovic
	...
	!clojure
	[:find ?instant :in $ ?n :where 
		[?p :name ?n] [?tx :db/txInstant ?instant]]
...
List name, team and salary, ordered by salary (desc) for 2011
	...
	!java
	Peer.q( query, conn.db().asOf( year2011 ) );
